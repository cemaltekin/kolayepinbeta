...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row justify-content-center" style="width: 700px;">
            <div class="col-md-8">
                <div class="card" style="left: 240px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control @error('password') i-invalid @enderror" name="password" required autocomplete="new-password">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <br> <br>
                                    Zaten Bir Hesabım Var. <br> <a href="/login">Giriş Yap</a>
                                </div>
                            </div>
                        </form>
                    </div>
